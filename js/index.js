...
// fecth all genres eg: [{"id": "123", "name": "Action"}]
// then change the formate eg : {123 : "Action"}

const genreList = {
    //create genre string from genre_id eg: [24,43] --> 
    // "Action" ,"Romance"
        ...
        sliderItem.innerHTML = `
            ...
            <div class="banner-content">
                ...
                <a href="./detail.html" class="btn">
                    <img src="./assets/images/play_circle.png" width="24" height="24" aria-hidden="true" alt="play circle" onclick="getMovieDetail(${id})">
